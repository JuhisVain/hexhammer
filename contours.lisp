    ...
    (macrolet ((rotation (bot-lefts top-rights)
		 ...
		 `(block water-filler
		    ,(cond
		       ...
		       ((and (eq left 'left)
			     (eq right 'bottom))
			`(when (and (< (contours-max ,left) (contours-water ,left))
				    (< (contours-max ,right) (contours-water ,right)))
			   ...
			   (cairo:line-to (x b-r-corner)
					  (y b-r-corner))
			   (when (and ;(< (contours-max ,other1) (contours-water ,other1))
				      (< (contours-max ,other2) (contours-water ,other2)))
			...
			`(when (and (< (contours-max ,left) (contours-water ,left))
		       ...
		       (t `(when (and (< (contours-max ,left) (contours-water ,left))
				      ;(< (contours-max ,right) (contours-water ,right))
				      ;(< (contours-max ,other1) (contours-water ,other1))
				      (< (contours-max ,other2) (contours-water ,other2)))
			     (cairo:move-to (x b-r-corner)
					    (y b-r-corner))
			     (cairo:line-to (x r-t-corner)
	...
	(prog1 nil
	  ...
	  (or
	   (fill-kite-water (left bottom) (top right)
			    ...
			    (let* ((surface (surface-level bottom))
	   ...
	   (fill-kite-water (top left) (right bottom)
			    ...
			    (let* ((surface (surface-level left))
				   (left-offset (offset-left surface left hex-radius))
				   (top-offset (offset-top surface top hex-radius))
