...
(defstruct (point (:constructor point (elevation)))
...
(defstruct (hex (:constructor
  ...
  (cen (point 0) :type point)
  (nne (point 0) :type point)
  (ne (point 0) :type point)
  (e (point 0) :type point)
  (se (point 0) :type point)
  (sse (point 0) :type point)
  (s (point 0) :type point)
  (ssw (point 0) :type point)
  (sw (point 0) :type point)
  (w (point 0) :type point)
  (nw (point 0) :type point)
  (nnw (point 0) :type point)
  (n (point 0) :type point))
